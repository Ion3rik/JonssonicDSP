...
TEST_F(OscillatorTest, SetFrequencyPerChannel) {
    osc.setFrequency(0u, 440.0f, true);  // Left channel: A4
    osc.setFrequency(1u, 880.0f, true);  // Right channel: A5 (octave higher)
...
TEST_F(OscillatorTest, MultiChannelIndependence) {
    ...
    quadOsc.setFrequency(0, 440.0f, true);
    quadOsc.setFrequency(1, 880.0f, true);
    quadOsc.setFrequency(2, 1320.0f, true);
    quadOsc.setFrequency(3, 1760.0f, true);
...
TEST_F(OscillatorTest, ZeroFrequency) {
    osc.setFrequency(0.0f, true);  // Skip smoothing to test actual zero frequency
    osc.reset();
