...
/**
 * @brief Planar to interleaved buffer conversion: planarBuffer [ch][samp] -> interleavedBuffer
 * [samp][ch]
 */
template <typename T>
void planarToInterleaved(const T* const* planarBuffer,
...
/**
 * @brief Interleaved to planar buffer conversion: interleavedBuffer [samp][ch] -> planarBuffer
 * [ch][samp]
 */
template <typename T>
void interleavedToPlanar(const T* const* interleavedBuffer,
